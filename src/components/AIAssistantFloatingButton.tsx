          ...
          <div className="min-h-0 flex-1 overflow-y-auto bg-gray-50 px-3 py-3">
            <div className="space-y-3">
              {messages.map(message => (
                ...
                >
                  <div
                    className={`max-w-[88%] whitespace-pre-wrap break-words rounded-lg px-3 py-2 text-sm leading-6 shadow-sm [overflow-wrap:anywhere] ${
                  ...
                  <div className="flex flex-wrap gap-2">
                    {starterQuestions.map(question => (
                      <button
                        ...
                        className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-left text-sm text-gray-700 transition-colors [overflow-wrap:anywhere] hover:border-teal-200 hover:text-teal-700"
                      >
                        {question}
                      </button>
                    ))}
